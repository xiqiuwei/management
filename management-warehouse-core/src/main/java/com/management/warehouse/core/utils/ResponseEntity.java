package com.management.warehouse.core.utils;


import com.management.warehouse.core.exception.CommonException;
...
public class ResponseEntity<T> {
    ...
    // 失败返回异常信息
    public static <T> ResponseEntity<T> fail (CommonException e) {
        log.info(e.toString());
        return new ResponseEntity<T>()
                .setCode(1)
                .setMessage(e.getMsg());
